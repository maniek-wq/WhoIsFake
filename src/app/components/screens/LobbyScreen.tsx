        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <GlassCard glow="blue" className="p-5">
              <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Room Code</p>
              ...
              <p className="text-xs text-slate-600">Share with friends to invite them</p>
            </GlassCard>
            ...
            <GlassCard className="p-5">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm text-slate-400">Ready status</span>
              ...
              {isHost && (
                <p className="text-xs text-slate-600">As host, you control the game start</p>
              )}
            </GlassCard>
          </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {player.id === currentPlayerId && (
                              <span className="text-xs bg-blue-500/15 text-blue-300 px-1.5 py-0.5 rounded font-medium">You</span>
                            )}
                          </div>
            ...
            {isHost && (
              ...
              >
                <GlassCard glow={canStart ? "blue" : "none"} className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="font-semibold text-white">Start the game</p>
                      <p className="text-xs text-slate-500 mt-0.5">
                        {players.length < 3
                          ? `Need at least ${3 - players.length} more player(s)`
                          : !allReady
